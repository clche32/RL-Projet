...
functions = [sliding_window] # [sliding_window, discounted_ucb, f_dsw]
params = [[T, 5000, 0.5, 0.6]]       # [ [T, int(4*np.sqrt(T*np.log(T))), 0.5, 0.6], [T, 0.9, 0.5, 0.6], [T, int(4*np.sqrt(T*np.log(T))), 0.9, 0.5, 0.6, np.min] ]
